...
function f1() {
  ...
  document.querySelector(".out-1").textContent = input == 4;
}
...
function f2() {
  let numMore;
  if (a21 > a22) numMore = a21;
  else numMore = a22;
  document.querySelector(".out-2").textContent = numMore;
}
...
function f3() {
  ...
  let numMore;
  if (+a31 > +a22) numMore = a31;
  else numMore = a32;
  document.querySelector(".out-3").textContent = numMore;
}
...
function f7() {
  ...
  let a72 = document.querySelector(".i-72").value;
  let degree = a71 ** a72;
...
// Task 10
// Дан select .s-100. По нажатию кнопки, выведите value выбранного option в .out-1.

function f10() {
  let a10 = document.querySelector(".s-100").value;
  document.querySelector(".out-10").textContent = a10;
}
...
function f11() {
  ...
  document.querySelector(".out-11").textContent = a11;
}
