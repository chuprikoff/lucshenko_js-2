...
goods2.name = "any_product";
goods2.amount = 1234;
goods2.image = `<img src="img/1.png" alt="pic">`;
goods2.count = 10;
goods2.draw(".out-4");
...
goods3.name = "any_product";
goods3.amount = 1234;
goods3.image = `<img src="img/2.png" alt="pic">`;
goods3.count = 10;
goods3.sale = 1; //true
goods3.draw(".out-6");
...
let valid = new Valid();
valid.email = "chuprikoff@yandex.ru";
valid.password = "qwert";
valid.validate();
...
let valid9 = new Valid();
valid9.email = "chuprikoff@yandex.ru";
valid9.password = "qwertyu";
valid9.validate();
...
let valid2 = new Valid2();
valid2.email = "";
valid2.password = "qwertyu";
valid2.validate();
console.log(valid2);
...
let valid3 = new Valid2();
valid3.email = "chuprikoff@yandex.ru";
valid3.password = "qwertyu";
valid3.validate();
console.log(valid3);
