...
let ar1 = ["qwerty", 125, -258, true, 25.6, "98", false, "developer", 0, 1]; // переменную обьявляем здесь!!!!
...
let ar2 = ar1; // переменную обьявляем здесь!!!!
...
let ar4 = ar1; // переменную обьявляем эту здесь!!!!
...
function f16() {
  ...
  for (let i = 0; i < ar16.length; i++) {
    if (ar16[i] % 2 == 0) {
      for (let k = ar16_even.length; true; k++) {
        ar16_even[k] = ar16[i];
        out16even += ar16_even[k] + " ";
        break;
      }
    } else {
      for (let l = ar16_odd.length; true; l++) {
        ar16_odd[l] = ar16[i];
        out16odd += ar16_odd[l] + " ";
        break;
      }
  ...
  document.querySelector(".out-16-odd").textContent = out16odd;
  document.querySelector(".out-16-even").textContent = out16even;
}
...
function f17() {
  ...
  document.querySelector(".out-17").textContent = item;
}
...
function f19() {
  ...
  document.querySelector(".out-19").textContent = item;
}
