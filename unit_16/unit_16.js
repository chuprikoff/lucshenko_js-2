...
function f3() {
  let out_ar = document.getElementsByClassName("out-3");
  for (let item of out_ar) {
    item.textContent = 3;
  }
}
...
function f4() {
  let out_ar = document.querySelectorAll(".out-4");
  for (let item of out_ar) {
    item.textContent += 4;
  }
}
...
function f15() {
  let elemsArr = document.querySelectorAll(".out-15");
  for (let item of elemsArr) {
    item.textContent = 15;
  }
}
