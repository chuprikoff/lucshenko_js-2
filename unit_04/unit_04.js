...
function f4() {
  let a4 = document.querySelector(".i-4").checked;
  document.querySelector(".out-4").textContent = a4;
}
...
function f5() {
  let a5 = document.querySelector(".i-5").checked;
  let a51 = document.querySelector(".i-5").value;

  if (a5) {
    document.querySelector(".out-5").textContent = a51;
  } else {
    document.querySelector(".out-5").textContent = a5;
  }
}
...
function f7() {
  let a71 = document.querySelector(".i-7").value;
  let a72 = +(a71.length >= 6);
  document.querySelector(".out-71").textContent = a71;
  document.querySelector(".out-72").textContent = a72;
}
...
function f9() {
  let a9 = document.querySelector(".r-9").checked;
  let a91 = document.querySelector(".r-9").value;

  if (a9) {
    document.querySelector(".out-9").textContent = a91;
  } else {
...
function f10() {
  ...
  document.querySelector(".out-10").style.background = a10;
}
